    ...
    return Dialog(
      ...
      child: SingleChildScrollView(
        ...
        child: Container(
          ...
          // Se agrega una restricción de ancho para hacerlo responsivo
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                // Campo de Descripción (no requiere validación especial)
                TextField(
                ...
                const SizedBox(height: 20),
                // Campo de Monto con validación y formateo de entrada
                TextFormField(
                  ...
                  inputFormatters: [
                    // Permite solo dígitos y punto decimal, impidiendo el signo negativo
                  ...
                  validator: (value) {
                    ...
                    // Se limita a 5 dígitos en la parte entera (monto menor a 100000)
                    if (amount >= 100000) {
                      return 'Ingrese un monto menor a 100000';
                    }
                    return null;
                  },
                ),
